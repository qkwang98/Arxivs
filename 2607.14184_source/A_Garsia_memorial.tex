...
He passed away in San Diego on October 6, 2024, at the age of 96.
  ...
  \begin{wrapfigure}{r}{0.4\textwidth}
    \centering
    \includegraphics[width=\linewidth]{garsialittle.jpeg}
...
In the Pisot case, conjugates inside the unit
  \begin{wrapfigure}{l}{0.4\textwidth}
    \centering
    \includegraphics[width=\linewidth]{mike.jpeg}
...
\begin{wrapfigure}{r}{0.3\textwidth}
  \centering
  \includegraphics[width=\linewidth]{mathtalkwadriano.jpg}
...
\begin{center}
    \includegraphics[width=.4\linewidth]{FB3.jpeg}
    \includegraphics[width=.4\linewidth]{FB1.jpeg}
\end{center}
...
\begin{wrapfigure}{l}{0.5\textwidth}
    \includegraphics[width=.95\linewidth]{FB2.jpeg}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.35\textwidth}
    \includegraphics[width=.95\linewidth]{DSCN3064.jpeg}
...
\begin{center}
\includegraphics[width=3in]{generations_step.jpg}\\
...
\begin{wrapfigure}{r}{0.5\textwidth}
    \includegraphics[width=.95\linewidth]{SD1_044.jpg}
...
\begin{wrapfigure}{l}{0.5\textwidth}
	\includegraphics[width=0.95\linewidth,clip=true,trim=25mm 15mm 20mm 25mm]{San_Diego_Kuskus.jpg}
...
\begin{center}
 \includegraphics[width=0.7\linewidth]{Garsiafest.jpeg} 
...
\begin{wrapfigure}{r}{0.4\textwidth}
    \includegraphics[width=0.95\linewidth]{IMG_8800.jpg}\\
