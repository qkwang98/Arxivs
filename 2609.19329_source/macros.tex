...
% citations
\newcommand{\arXiv}[1]{\href{http://arxiv.org/abs/#1}{\tt \nolinkurl{arXiv:#1}}}
\newcommand{\doi}[1]{\href{http://dx.doi.org/#1}{{\tt \nolinkurl{DOI:#1}}}}
...
\hyphenation{Resh-e-tikh-in}


\newcommand{\noah}[1]{\textcolor{blue}{[#1]}}


% Commands for exceptional paper
\DeclareMathOperator{\eval}{eval}
\DeclareMathOperator{\Qeval}{Qeval}
\newcommand{\QExc}{\mathsf{QExc}}
...
% Grab specifically the blackboard-bold "1" for bbold. The standard
% letters are kind of ugly there.
...
% Collecting definitions from inside the document
