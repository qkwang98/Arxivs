...
def main():
    ...
    parser.add_argument('--source', type=Path, default=ROOT/'results/rigid_oscillatory_checked_e02/results.json')
    parser.add_argument('--output', type=Path, default=ROOT/'results/rigid_oscillatory_controls')
